        ...
        <main>
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p>
                    Showcase your skills and preferences in a format that works
                    for you.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p>
                    Our matching algorithm finds employers that fit your unique
                    talents.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p>
                    Access resources and support to succeed in your new role.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
                We're committed to empowering individuals, promoting inclusion,
                and driving positive social change. Join us in creating a more
          ...
          <section className="py-20">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
                Join NeuroTalent today and be part of a community that values
        ...
        <footer>
          <div className="container mx-auto px-4">
            ...
            <div className="mt-4 flex justify-center space-x-4">
              <a
                href="mailto:support@neurotalent.com"
                className="text-sm hover:text-gray-500"
              >
                support@neurotalent.com
              </a>
...
function FeatureCard({
  ...
  return (
    <div
      className={`flex flex-col items-center space-y-2 p-6 rounded-lg shadow-lg`}
    >
